// this module extracts images from videos
// first number of frames and duration is calculated and prompt is given to extract x frames per second
// ffmpeg extracts the frames 
// an ai prompt tells the context for further processing

const path = require('path')
const fs = require('fs').promises
const { exec } = require('child_process')

const getVideoDuration = ({ inputFile }) => { // get the total duration of the vid, ffprobe does the job
...
module.exports = async ({ frames, inputFile, framesOutputDir }) => { // main function, evenly spaces out the frames in an array and a prompt to generate relevance bw the images
  try {
